...
public class SList {
  ...
  public void squish() {
	  ...
	  if(head == null)
		  return;
	  SListNode current_node = head;
	  SListNode next_node = head.next;
	  while(next_node != null)
	  {
			 while(current_node.item.equals(next_node.item) )
			 {
  ...
  public void twin() {
    ...
    while(current != null)
    {
    	...
    	SListNode copy = new SListNode(current.item,current.next);
    	current.next = copy;
    	current = copy.next;
